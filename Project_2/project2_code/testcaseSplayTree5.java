//TESTCASE (Splay) 5: We will analyze the worst-case time for each operation - insert(), search() and delete()

import java.util.*;

public class testcaseSplayTree5 {
	...
	public static void main(String[] args) {
		...
		TreeOperations hashfunc = new SplayTree();
