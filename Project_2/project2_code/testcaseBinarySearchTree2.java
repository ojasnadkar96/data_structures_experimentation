//TESTCASE (BST) 2: We analyze time for insert(), search() and delete() over 100 random values

import java.util.*;
import java.text.*;

public class testcaseBinarySearchTree2 {
	...
	public static void main(String[] args) {
		...
		TreeOperations treefunc = new BinarySearchTree();
