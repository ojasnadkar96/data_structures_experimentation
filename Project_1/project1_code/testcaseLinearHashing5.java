//TESTCASE (LINEAR HASHING) 5: We will analyze the worst-case time for each operation - put(), get() and remove()

import java.util.*;

public class testcaseLinearHashing5 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new LinearHashing(0.5); //load factor of 0.5 (default)
