//TESTCASE (LINEAR HASHING) 2: We analyze time for put(), get() and remove() over 1000 random values with a load factor of 0.5

import java.util.*;
import java.text.*;

public class testcaseLinearHashing2 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new LinearHashing(0.5); //load factor 0.5
