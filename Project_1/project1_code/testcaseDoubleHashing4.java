//TESTCASE (DOUBLE HASHING) 4: We analyze time for put(), get() and remove() over 1000 random values with a load factor of 1.00

import java.util.*;
import java.text.*;

public class testcaseDoubleHashing4 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new DoubleHashing(1.00); //load factor 1.00
