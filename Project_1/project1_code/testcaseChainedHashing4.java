//TESTCASE (CHAINED HASHING) 4: We analyze time for put(), get() and remove() over 10000 random values with table size 5000

import java.util.*;
import java.text.*;

public class testcaseChainedHashing4 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new ChainedHashing(5000); //table size 500
		...
		System.out.println();
		System.out.println("Intial hash table size is considered as half of input values");
		System.out.println();
