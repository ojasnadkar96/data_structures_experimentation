//TESTCASE (CUCKOO HASHING) 3: We analyze time for put(), get() and remove() over 1000 random values with table size 500

import java.util.*;
import java.text.*;

public class testcaseCuckooHashing3 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("Intial hash table size is considered as half of input values & resized when cycles detecte");
		System.out.println();
