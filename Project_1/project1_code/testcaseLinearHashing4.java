//TESTCASE (LINEAR HASHING) 4: We analyze time for put(), get() and remove() over 1000 random values with a load factor of 1.00

import java.text.*;
import java.util.*;

public class testcaseLinearHashing4 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new LinearHashing(1.00); //load factor of 1.00
