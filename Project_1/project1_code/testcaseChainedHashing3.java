//TESTCASE (CHAINED HASHING) 3: We analyze time for put(), get() and remove() over 1000 random values with table size 500

import java.util.*;
import java.text.*;

public class testcaseChainedHashing3 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new ChainedHashing(500); //table size 5000
