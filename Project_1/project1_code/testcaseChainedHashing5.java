//TESTCASE (CHAINED HASHING) 5: We will analyze the worst-case time for each operation - put(), get() and remove()

import java.util.*;

public class testcaseChainedHashing5 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new ChainedHashing(500); //table size 500
