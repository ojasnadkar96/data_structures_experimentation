//TESTCASE (CUCKOO HASHING) 4: We analyze time for put(), get() and remove() over 10000 random values with table size 5000

import java.util.*;
import java.text.*;

public class testcaseCuckooHashing4 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new CuckooHashing(5000); //table size 5000
