//TESTCASE (DOUBLE HASHING) 3: We analyze time for put(), get() and remove() over 1000 random values with a load factor of 0.75

import java.util.*;
import java.text.*;

public class testcaseDoubleHashing3 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new DoubleHashing(0.75); //load factor 0.75
