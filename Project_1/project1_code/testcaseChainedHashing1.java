//TESTCASE (CHAINED HASHING) 1: Checks correctness of the algorithm based on a small input example

public class testcaseChainedHashing1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		HashOperations hashfunc = new ChainedHashing(16); //default table size of 16
		hashfunc.put(50,1);
		hashfunc.put(700,2);
		hashfunc.put(76,3);
		hashfunc.put(85,4);
