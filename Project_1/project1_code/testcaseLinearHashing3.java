//TESTCASE (LINEAR HASHING) 3: We analyze time for put(), get() and remove() over 1000 random values with a load factor of 0.75

import java.text.*;
import java.util.*;

public class testcaseLinearHashing3 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new LinearHashing(0.75); //load factor of 0.75
