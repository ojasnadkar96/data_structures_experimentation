//TESTCASE (DOUBLE HASHING) 1: Checks correctness of the algorithm based on a small input example

public class testcaseDoubleHashing1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		HashOperations hashfunc = new DoubleHashing(0.5); //default load factor of 0.5
		hashfunc.put(50,1);
		hashfunc.put(700,2);
		hashfunc.put(76,3);
		hashfunc.put(85,4);
