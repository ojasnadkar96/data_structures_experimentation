//TESTCASE (CHAINED HASHING) 2: We analyze time for put(), get() and remove() over 100 random values with table size 50

import java.util.*;
import java.text.*;

public class testcaseChainedHashing2 {
	...
	public static void main(String[] args) {
		...
		HashOperations hashfunc = new ChainedHashing(50); //table size 50
